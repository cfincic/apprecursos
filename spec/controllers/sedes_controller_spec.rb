  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved sede as @sede" do
        ...
        post :create, {:sede => { "descripcion" => "invalid value" }}, valid_session
        assigns(:sede).should be_a_new(Sede)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested sede" do
        ...
        Sede.any_instance.should_receive(:update).with({ "descripcion" => "MyString" })
        put :update, {:id => sede.to_param, :sede => { "descripcion" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the sede as @sede" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Sede.any_instance.stub(:save).and_return(false)
        put :update, {:id => sede.to_param, :sede => { "descripcion" => "invalid value" }}, valid_session
        assigns(:sede).should eq(sede)
      end
