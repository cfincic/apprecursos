class TipoContratacionesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @tipo_contratacion.save
        format.html { redirect_to @tipo_contratacion, notice: 'Tipo contratacion was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @tipo_contratacion.update(tipo_contratacion_params)
        format.html { redirect_to @tipo_contratacion, notice: 'Tipo contratacion was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to tipo_contrataciones_url, notice: 'Tipo contratacion was successfully destroyed.' }
