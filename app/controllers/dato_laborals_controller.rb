...
class DatoLaboralsController < ApplicationController
  ...
  private
    ...
    def dato_laboral_params
      params.require(:dato_laboral).permit(:agente_id, :acto_administrativo_id, :tramo_id, :agrupamiento_id, :num_legajo, :sede_id, :hora_desde, :hora_hasta,
       :interno, :fecha_ingreso, :fecha_acto, :nro_acto, :fecha_entrega, :fecha_examen_periodico, :funcion,:situ_revista, :nivel, :fecha_acto, :fecha_apto_fisico, :fecha_curriculum, :antecedentes_penales, :fecha_antecedentes_penales,
